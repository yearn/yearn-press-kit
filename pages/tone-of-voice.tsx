			...
			<div className={'grid grid-cols-1 gap-x-20 pb-20'}>
				<ContentCard
					...
					<div className={'flex flex-row items-center space-x-6'}>
						<a href={'/tone-of-voice/tone_of_voice.png'} download className={'border-primary text-primary h-10 w-full border py-2 text-center font-bold hover:bg-light-blue lg:w-[184px] lg:pt-3 lg:text-xs xl:py-2 xl:text-base'}>{'Download PDF'}</a>
					</div>
				</ContentCard>
			</div>
		</section>
